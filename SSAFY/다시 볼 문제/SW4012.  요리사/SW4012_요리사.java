...
public class SW4012_요리사 {
	static int T, N, min;
	static int[][] map;
	static int[] arrA, arrB; // 각각 두 그룹 A, B 으로 재료를 나누었을 때, 재료의 index 를 관리
	// 0, 1, 2, 3, 4, 5
	// A : 1, 3, 4
	// B : 0, 2, 5
	...
	static void comb(int srcIdx, int tgtIdx) {
		...
		// src 로 부터 선택된 항목을 tgt 자료구조에 담고 이어가는 게 (덮어쓰게 된다) 아니라, select 에 표시 이어간다.
		select[srcIdx] = true;
